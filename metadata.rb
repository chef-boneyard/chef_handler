...
source_url 'https://github.com/opscode-cookbooks/chef_handler' if respond_to?(:source_url)
issues_url 'https://github.com/opscode-cookbooks/chef_handler/issues' if respond_to?(:issues_url)
